...
/* lbfgs.f -- translated by f2c (version 20020621).
...
static int daxpy_(integer *, doublereal *, doublereal *, 
				   integer *, doublereal *, integer *);
static int mcsrch_(integer *, doublereal *, doublereal *,
		   doublereal *, doublereal *, doublereal *, doublereal *, 
		   doublereal *, integer *, integer *, integer *, doublereal *);
static int mcstep_(doublereal *, doublereal *, 
		   doublereal *, doublereal *, doublereal *, doublereal *, 
